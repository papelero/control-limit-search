...
setup(
    ...
    packages=["control_limits",
              "control_limits.src",
              "control_limits.datasets.chinatown", "control_limits.datasets.gunpoint_oldversusyoung",
              "control_limits.datasets.synthetic_data"],
    ...
    # URL of the project
    url="https://github.com/papelero/control-limit-search",
